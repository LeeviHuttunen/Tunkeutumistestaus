...
Määritin payloadin, rhostin, lhostin, mutta ei toiminut. Tarkemmalla katselulla ja ajattelulla portti on varmaan väärä, koitetaan portilla 80: (Edit. Portti ei ollut väärä, vaan arkkitehtuurityyppi. Pitäisi olla Linux x86, eikä x64.)
...
Edit. Oppitunnilla annettiin muutamia vinkkejä, missä voisi olla vika. Muutama asia mitä tein. Ensinnäkin piti avata kohdekoneesta tulimuuri. Avasin tulimuurin komennolla `sudo ufw allow 80`, joka avasi portin 80. Toisena huomiona oli, että Format puuttui, jolloin aikaisempi komento ei toiminut. Joten tässä oikea komento:

<img width="866" height="194" alt="image" src="https://github.com/user-attachments/assets/f3db8de9-8c1d-4099-b91e-22e9eed530be" />

Jonka jälkeen määritellään asetukset:

<img width="756" height="289" alt="image" src="https://github.com/user-attachments/assets/aa3feeb8-9ce8-4c3f-b8a2-48e90d75e061" />

Yllä olevassa kuvassa jouduin vielä vaihtamaan arkkitehtuurin x64.

Sitten avasin uuden terminal-ikkunan jossa muokkasin infectedin käyttäjäoikeuksia ja menin hakemistoon.

<img width="200" height="108" alt="image" src="https://github.com/user-attachments/assets/7f14f1d4-9582-454c-a2bc-4d628a694fce" />

Jonka jälkeen oli ilmestynyt uusi Meterpreter sessio:

<img width="864" height="80" alt="image" src="https://github.com/user-attachments/assets/61c3dfc1-f3c9-4574-b724-de5337185fd6" />

Ja sitten `ls`, jolla näin listan hakemistosta:

<img width="651" height="278" alt="image" src="https://github.com/user-attachments/assets/a1c3a5c3-c19e-4966-8b43-7d049850b985" />
