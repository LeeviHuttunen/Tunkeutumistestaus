...
Määritin payloadin, rhostin, lhostin, mutta ei toiminut. Koitan jos joku toinen portti toimisi, jos se on siitä kiinni.

<img width="461" height="272" alt="image" src="https://github.com/user-attachments/assets/796a8969-8dfc-4e92-bce5-314ee8789c71" />

Tehtävä ei tuottanut haluttua lopputulosta. 

Mielessäni myös kävi, jos siirtäisin tiedoston ftp:llä Metaspoitable-koneelle, mutta en saanut siihen yhteyttä ilman nettiyhteyttä, enkä viitsinyt laittaa nettiä päälle ja alkaa siirtämään haittaohjelmia, kun kone on kytketty verkkoon.
