...
(Edit. Tajusin hetken kuluttua läppärin sulkemisen jälkeen, että enhän ollut avannut tiedostoa Kali-koneellani.) Sen jälkeen pääsin sisään ja tehtävän pariin:
...
(EDIT: Juuri palautuksen jälkeen tajusin, etten ollut avannut ohjelmaa kalissa. Päivitän parhaillaan tehtävää)
