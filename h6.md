...
Jonka jälkeen otin http-yhteyden eräällä toisella implantilla:

<img width="935" height="332" alt="image" src="https://github.com/user-attachments/assets/b126686a-beb8-445e-87dd-87f996118994" />

## c) Sniff Sliver! Tarkastele Sliverin http-yhteyttä snifferillä. Mitä havaitset? Mistä ominaisuuksista yhteyden voi tunnistaa?

- Vaikka en ollut internetissä ja netti oli pois päältä, koko ajan tuli ja lähti uusia paketteja:

<img width="1240" height="277" alt="image" src="https://github.com/user-attachments/assets/d13c97a1-f6f1-4e89-8cee-d734a014ca0e" />

- Mielestäni myös http-pyynnöt, joissa lukee jatkuvasti no content, ovat epäilyttäviä.
...
(Edit. Tajusin hetken kuluttua läppärin sulkemisen jälkeen, että enhän ollut avannut malware-tiedostoa Kali-koneellani.) Sen jälkeen pääsin sisään ja tehtävän pariin:

<img width="935" height="332" alt="image" src="https://github.com/user-attachments/assets/b126686a-beb8-445e-87dd-87f996118994" />



Muutin yhteyden Shelliksi, koska olen aikuinen, ainakin fyysisesti:

<img width="660" height="141" alt="image" src="https://github.com/user-attachments/assets/27839c97-8d0f-41d3-8ddb-922fca9a2905" />

- Loin uuden yhteyden https:llä näinkin helposti:

<img width="359" height="132" alt="image" src="https://github.com/user-attachments/assets/055ec444-e140-4f4b-8b3a-5e8ef496d919" />



## e) Sliverillä voi tehdä monenlaista kohteessa, ruutukaappauksista alkaen. Näytä esimerkkejä toiminnoista.

- Komennolla `screenshot´ ottaa screenshotin

<img width="758" height="96" alt="image" src="https://github.com/user-attachments/assets/71b8a624-1dfc-4e1e-8558-dd3e01407f73" /> 

- Infolla näkee koneen tiedot:

<img width="501" height="344" alt="image" src="https://github.com/user-attachments/assets/7f723511-776b-4e8f-917b-c1875e1553ce" />

- Netstat näyttää yhteyden tiedot:

<img width="730" height="106" alt="image" src="https://github.com/user-attachments/assets/9c61fbb6-8aca-4e4b-8d56-bab90f27a13c" />


Ja tosiaan Shellillä pystyy muuttamaan Beaconin tai session Shelliksi.
